...
from login.dbzdb.cookies import DbzdbCookies
...
class DbzdbCookiesGenerator(CookiesGenerator):
    def __init__(self, website='dbzdb'):
        """
        初始化操作
        :param website: 站点名称
        :param browser: 使用的浏览器
    ...
    def new_cookies(self, username, password):
        ...
        :return: 用户名和Cookies
        """
        return DbzdbCookies(username, password, self.browser).main()
